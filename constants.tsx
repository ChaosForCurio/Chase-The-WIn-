...
// Standard Cburnett Chess Pieces (High Quality)
export const PIECE_PATHS: Record<string, React.JSX.Element> = {
  ...
  [`${PieceColor.w}${PieceType.k}`]: (
    <g fill="#fff" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-1-5 2-8 2s-4-1-9-1-5 2-8 2-2-2.36-8-2c-3 6 6 10.5 6 10.5v7z" fill="#fff" />
  ...
  [`${PieceColor.b}${PieceType.k}`]: (
    <g fill="#000" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-1-5 2-8 2s-4-1-9-1-5 2-8 2-2-2.36-8-2c-3 6 6 10.5 6 10.5v7z" fill="#000" />
      <path d="M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0" />
    </g>
  ),
};